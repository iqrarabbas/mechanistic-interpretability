...
# Training data: first 10,000 blurred images
...
# Validation data: next 1,000 blurred images
...
for epoch in range(epochs):
    ...
    print("Evaluating on validation blur set...")
    val_results = evaluate_model(model, val_loader, device)
    val_top1 = val_results["top1"]

    print(
        f"Validation Blur Top-1: {val_results['top1']:.4f} | "
...
print("\nTraining finished.")
print(f"Best validation blur Top-1: {best_val_top1:.4f}")
